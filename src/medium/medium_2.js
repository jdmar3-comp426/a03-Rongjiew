...
export const allCarStats = {
    ...
    allYearStats: getYearStas(mpg_data),
...
export function getAvgMpg(array) {
    ...
    let result = {city: city_avg, highway: highway_avg};
    return result;
};
...
export function getYearStas(array) {
    const year = [];
    for (let i=0; i<array.length; i++) {
...
export function getAvgMpgByYear(array) {
    ...
    for (let i=0; i<yeay.length; i++) {
        ...
        let hybrid_avg = getAvgMpg(arr_hyb);
        let notHybrid_avg = getAvgMpg(arr_nonhyb);
